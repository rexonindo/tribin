<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Unit of Measurement</h1>
    ...
    <div class="row">
        <div class="col-md-6 mb-1">
            <div class="input-group input-group-sm mb-1">
                ...
                <input type="text" id="coaCode" class="form-control" placeholder="PCS" maxlength="30">
        ...
        <div class="col-md-6 mb-1">
            <div class="input-group input-group-sm mb-1">
                ...
                <input type="text" id="coaName" class="form-control" placeholder="Pieces" maxlength="100">
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">UOM List</h1>
...
<script>
    ...
    function btnSaveOnclick(pthis) {
        ...
        const data = {
            MUOM_UOMCD: coaCode.value.trim(),
            MUOM_UOMNM: coaName.value.trim(),
            _token: '{{ csrf_token() }}',
        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.data.forEach((arrayItem) => {
                        ...
                        newcell.innerHTML = arrayItem['MUOM_UOMCD']
                        newcell.style.cssText = 'cursor:pointer'
                        newcell.onclick = () => {
                            $('#coaModal').modal('hide')
                            coaInputMode.value = 1
                            coaCode.value = arrayItem['MUOM_UOMCD']
                            coaName.value = arrayItem['MUOM_UOMNM']
                            coaCode.disabled = true
                        }
                        newcell = newrow.insertCell(1)
                        newcell.innerHTML = arrayItem['MUOM_UOMNM']
                    })
