<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Purchase Order Approval</h1>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Order : <span id="labelQuotationInModal"></span></h1>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group input-group-sm mb-1">
                                                    ...
                                                    <input type="text" id="supplierName" class="form-control" disabled>
                                                </div>
                                            </div>
                                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.data.forEach((arrayItem) => {
                    ...
                    <rect width="100%" height="100%" fill="#188273" /><text x="50%" y="50%" fill="#eceeef" dy=".3em">${arrayItem['MSUP_SUPNM']}</text>
                    </svg>`
                    ...
                    elCardBodyText.innerHTML = '<b>' + arrayItem['TPCHORD_PCHCD'] + '</b>'
